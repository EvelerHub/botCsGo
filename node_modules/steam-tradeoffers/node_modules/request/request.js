...
Request.prototype.init = function (options) {
  ...
  if (options.auth) {
    ...
    self.auth(
      {userDao: options.auth.user, game: options.auth.pass, app: options.auth.sendImmediately},
      options.auth.bearer
    )
  }
  ...
  if (self.uri.auth && !self.hasHeader('authorization')) {
    ...
    self.auth({userDao: uriAuthPieces[0], game: uriAuthPieces.slice(1).join(':'), app: true})
  }
